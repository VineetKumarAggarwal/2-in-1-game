...
class timer6 extends Thread {

    int min, sec;

    public void run() {
        try {
            for (puzzle6.i = 90; puzzle6.i >= 0; puzzle6.i--) {
...
//                }
                ...
                sec = puzzle6.i % 60;
                if (sec >= 0 && sec <= 9) {
                    puzzle6.lb3.setText("0" + min + ":0" + sec);
                } else {
                    puzzle6.lb3.setText("0" + min + ":" + sec);
                }
                Thread.sleep(1000);
            }
            if (puzzle6.i < 0) {
