...
public class puzzle1 extends JFrame implements ActionListener {
    ...
    puzzle1() throws InterruptedException {
        setLayout(null);
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (ae.getSource() == b9) {
            ...
            if (b1.getLabel().equals("1") && b2.getLabel().equals("2") && b3.getLabel()
                ...
                JOptionPane.showMessageDialog(puzzle1.this, "You have completed the Puzzle 1.");
                this.dispose();
                new puzzle2();
            }
        }
        ...
        if (ae.getSource() == bt2) {
            JOptionPane.showMessageDialog(puzzle1.this, "You will lost all the progress by quiting the game.");
            this.dispose();
            t.stop();
            new Games();
        }
