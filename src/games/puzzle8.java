    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (ae.getSource() == b9) {
            ...
            if (b1.getLabel().equals("1") && b2.getLabel().equals("2") && b3.getLabel()
                ...
                JOptionPane.showMessageDialog(puzzle8.this, "You have completed the Puzzle 1.");
                new puzzle7();
                this.dispose();
            }
        }
        ...
        if (ae.getSource() == bt2) {
            JOptionPane.showMessageDialog(puzzle8.this, "You will lost all the progress by quiting the game.");
            new Games();
            t.stop();
            this.dispose();
        }
...
class timer8 extends Thread {

    int min, sec;

    public void run() {
        try {
            for (puzzle8.i = 90; puzzle8.i >= 0; puzzle8.i--) {
...
//                }
                ...
                sec = puzzle8.i % 60;
                if (sec >= 0 && sec <= 9) {
                    puzzle8.lb3.setText("0" + min + ":0" + sec);
                } else {
                    puzzle8.lb3.setText("0" + min + ":" + sec);
                }
                Thread.sleep(1000);
            }
            if (puzzle8.i < 0) {
