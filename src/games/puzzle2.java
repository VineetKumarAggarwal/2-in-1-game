...
public class puzzle2 extends JFrame implements ActionListener {
    ...
    static int i;
    static String over = "false";
    timer2 t = new timer2();

    puzzle2() {
        setLayout(null);

        lb1 = new JLabel("PUZZLE 2");
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (ae.getSource() == b9) {
            ...
            if (b1.getLabel().equals("1") && b2.getLabel().equals("2") && b3.getLabel()
                ...
                JOptionPane.showMessageDialog(puzzle2.this, "You have completed the Puzzle 2.");
                this.dispose();
                over = "true";
                new puzzle3();
            }
        ...
        if (ae.getSource() == bt2) {
            JOptionPane.showMessageDialog(puzzle2.this, "You will lost all the progress by quiting the game.");
            new Games();
            t.stop();
            this.dispose();
        }
...
class timer2 extends Thread {
    ...
    public void run() {
        try {
            for (puzzle2.i = 120; puzzle2.i >= 0; puzzle2.i--) {
...
//                }
                ...
                sec = puzzle2.i % 60;
                if (sec >= 0 && sec <= 9) {
                    puzzle2.lb3.setText("0" + min + ":0" + sec);
                } else {
                    puzzle2.lb3.setText("0" + min + ":" + sec);
                }
                Thread.sleep(1000);
            }
            if (puzzle2.i < 0) {
